...
package drawlogic.as3.game.tileengine
{
	...
	*/
	...
	public class TilePosition extends MovieClip
	{
		public var currentX:int = 0;
		public var currentY:int = 0;
		public var currentZ:int = 0;
		
		public var currentHeight:int = 0;
		public var currentRotation:Number = 0;
		public var currentGroupsArray:Array = new Array();
		public var currentWaypoint:String = "";		
		
		public function TilePosition()
		{
